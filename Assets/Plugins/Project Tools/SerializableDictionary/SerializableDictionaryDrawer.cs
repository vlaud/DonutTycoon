...
namespace Project.Tools.DictionaryHelp
{
    ...
    public class SerializableDictionaryDrawer : PropertyDrawer
    {
        ...
        {
            // 직렬화 프로퍼티 X, 직렬화 오브젝트 X, 직렬화 오브젝트의 타깃 X
            ...
            void Head()
            {
                ...
                void DuplicatedKeysWarning()
                {
                    ...
                    {
                        if (dictionaryList == null || dictionaryList.arraySize == 0)
                            return;
        ...
        private float GetListElementHeight(int index)
        {
            ...
            if (kvpProp == null) return EditorGUIUtility.singleLineHeight;
